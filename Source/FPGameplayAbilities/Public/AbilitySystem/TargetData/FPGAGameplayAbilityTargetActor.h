...
#include "FPGAGameplayTargetDataFilter.h"
#include "FPGAGameplayAbilityTargetActor.generated.h"
...
class FPGAMEPLAYABILITIES_API AFPGAGameplayAbilityTargetActor : public AActor
{
	GENERATED_BODY()

public:
	AFPGAGameplayAbilityTargetActor(const FObjectInitializer& ObjectInitializer);
	...
	FFPGAGameplayTargetDataFilter Filter;
