...
#include "FPGAAsyncTask_CooldownChanged.generated.h"
...
class FPGAMEPLAYABILITIES_API UFPGAAsyncTask_CooldownChanged : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	static UFPGAAsyncTask_CooldownChanged* ListenForCooldownChange(UAbilitySystemComponent* AbilitySystemComponent, FGameplayTagContainer CooldownTags, bool UseServerCooldown);
